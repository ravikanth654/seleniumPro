...
public class riteVinWithNextNavigationTest extends TestInit
{
    @Test
    public void riteVinWithNextNavigation()throws Exception {
        ExtentTest t1 = pNode.createNode("riteVinWithNextNavigation", "riteVinWithNextNavigation");
        ...
        boolean is = heatMap_PathTracking_Geofencing.init(t1).selectDateVisible();
        System.out.println(is);

        Assertion.assertEqual(is,true,"both true",t1);
