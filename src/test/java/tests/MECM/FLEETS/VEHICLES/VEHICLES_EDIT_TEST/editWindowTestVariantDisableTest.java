...
public class editWindowTestVariantDisableTest extends TestInit
{
    @Test(priority = 0)
    public void editWindowTestVariantDisable() throws IOException, InterruptedException {
        ...
        boolean verify = fleetVehiclesPage.init(t1).modis();
