...
public class successfulyVehicleAssignedTest extends TestInit
{
    String driverName;
    String fleetName;
    String SwappedVehicle;
    String fnt1;
    String snt1;
    String gt1;
    String mt1;
    ...
    String doc;
    @Test
    public void successfulyVehicleAssigned() throws Exception
    {
        ExtentTest t1 = pNode.createNode("successfulyVehicleAssigned", "successfulyVehicleAssigned");
...
//Address
        ...
        Thread.sleep(1000);
        SwappedVehicle = SubFleetsPage.init(t1).afterSwap();
        System.out.println("b "+SwappedVehicle);
        ...
        fleetVehiclesPage.init(t1).search_sendvalue(SwappedVehicle);
        fleetVehiclesPage.init(t1).clickSearch();
        Thread.sleep(1000);
        String s2s = fleetVehiclesPage.init(t1).getFirstRowLicencePlate();
