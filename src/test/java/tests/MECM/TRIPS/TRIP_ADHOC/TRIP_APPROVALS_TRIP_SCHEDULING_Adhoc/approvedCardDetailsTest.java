...
public class approvedCardDetailsTest extends TestInit
{
    @Test
    public void approvedCardDetails() throws Exception {
        ExtentTest t1 = pNode.createNode("approvedCardDetails ", "approvedCardDetails");
        ...
        Thread.sleep(1000);
        tripAdhoc.init(t1).tripDetailsClick();
        Thread.sleep(3000);
