...
public class invalidMobileOfAgencyVehiclesTest extends TestInit
{
    String reg;
    @Test(priority = 0)
    public void invalidMobileOfAgencyVehicles() throws Exception {
        ExtentTest t1 = pNode.createNode("invalidMobileOfAgencyVehicles ", "invalidMobileOfAgencyVehicles");
        ...
        tripAdhoc.init(t1).agencyDriverMobile("973891712");
