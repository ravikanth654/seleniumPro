...
public class checkForVehicleAssignedTest extends TestInit
{
    @Test
    public void checkForVehicleAssigned() throws Exception {
        ExtentTest t1 = pNode.createNode("checkForVehicleAssigned ", "checkForVehicleAssigned");
        ...
        String otype = inTrips.init(t1).vehicleAssignedAdhoc();
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        WebElement button11 = driver.findElement(By.xpath("//a[.=' VEHICLE DETAILS ']"));
        js.executeScript("arguments[0].click();", button11);
        // inTrips.init(t1).ClickvehiclesDetails();
        Thread.sleep(2000);
        String intype = inTrips.init(t1).inRegestrationNumber();


        Assertion.assertEqual(otype,intype,"same",t1);
