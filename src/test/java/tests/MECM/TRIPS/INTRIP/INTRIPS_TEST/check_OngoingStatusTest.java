...
public class check_OngoingStatusTest extends TestInit
{
    ArrayList<String> statusAll = null;
    String statuss = null;
    @Test
    public void check_OngoingStatus() throws Exception
    {
        ExtentTest t1 = pNode.createNode("check_OngoingStatus ", "check_OngoingStatus");
